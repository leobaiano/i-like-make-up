...
define('DB_NAME', 'tedk07');

/** Usuário do banco de dados MySQL */
define('DB_USER', 'tedk07');

/** Senha do banco de dados MySQL */
define('DB_PASSWORD', 'tedk3372');

/** Nome do host do MySQL */
define('DB_HOST', 'mysql.tedk.com.br');
...
define( 'WP_SITEURL', 'http://' . $_SERVER['HTTP_HOST'] . '/projeto/i-like-make-up' );
define( 'WP_HOME', 'http://' . $_SERVER['HTTP_HOST'] . '/projeto/i-like-make-up' );
